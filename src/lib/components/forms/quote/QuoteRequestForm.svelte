  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
      ...
      <div class="mb-2 max-w-2xl space-y-8 text-center lg:mb-8 lg:max-w-[600px] lg:text-left">
        ...
        <!-- Trust & Privacy -->
        <div class="rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-lg sm:p-6">
          <div class="flex gap-3">
            ...
            <div>
              <p class="text-xs leading-relaxed text-slate-700">
                ...
                We respect your privacy. Your contact information will never be sold or shared with third parties. We only use your details
                to provide you with a personalized painting estimate.
              </p>
            </div>
          </div>
        </div>
      ...
      <form onsubmit={handleSubmit} class="w-full space-y-4 lg:w-[500px]">
        <div class="rounded-3xl border border-slate-200 bg-white px-6 py-10 shadow-sm transition-shadow hover:shadow-md sm:px-8 sm:py-12">
          <!-- Personal Info -->
          <div class="space-y-6">
            <div class="mb-6">
            ...
            <div class="mt-10 flex flex-col gap-3 sm:mt-12 sm:flex-row sm:items-center sm:gap-4">
          ...
          <div class="hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
            <div>
              <h3 class="mb-3 text-sm font-bold tracking-wider text-slate-500 uppercase">Project Details</h3>
              <div>
                <label for="description" class="mb-1.5 block text-xs font-semibold text-slate-600">Project Description</label>
                <textarea
                  id="description"
                  rows="4"
                  maxlength={maxChars}
