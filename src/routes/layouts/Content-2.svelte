		...
		>
			<div class="relative lg:order-last lg:col-span-5">
				...
				>
					...
					<rect width="100%" height="100%" fill="url(#e87443c8-56e4-4c20-9111-55b82fa704e3)" stroke-width="0" />
				</svg>
			...
			<div class="max-w-xl text-base/7 text-gray-600 lg:col-span-7 dark:text-gray-400">
				...
				<ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600 dark:text-gray-400">
					<li class="flex gap-x-3">
						...
						<span>
							<strong class="font-semibold text-gray-900 dark:text-white">Push to deploy.</strong>
					...
					<li class="flex gap-x-3">
						...
						<span>
							<strong class="font-semibold text-gray-900 dark:text-white">SSL certificates.</strong>
					...
					<li class="flex gap-x-3">
						...
						<span>
							<strong class="font-semibold text-gray-900 dark:text-white">Database backups.</strong>
				...
				<p class="mt-8">
					...
					fermentum dignissim. Lacus diam tincidunt ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing
